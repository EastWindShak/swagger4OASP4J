...
<#if property.isEntity>
   	private ${OaspUtil.getOaspTypeFromOpenAPI(property, false, false)}Eto ${property.name};
</#if>
</#list>
...
<#list model.properties as property>
	<#if property.isEntity>
	public ${OaspUtil.getOaspTypeFromOpenAPI(property, false, false)}Eto get${property.name?cap_first}() {
		return this.${property.name};
	}
	
	public void set${property.name?cap_first}(${OaspUtil.getOaspTypeFromOpenAPI(property, false, false)}Eto ${property.name}) {
