...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.capgemini.demo.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.capgemini.demo.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
