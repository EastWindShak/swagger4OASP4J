package com.capgemini.demo.general.common.api.exception;

import com.capgemini.demo.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link com.capgemini.demo.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the demoEntity entity.
