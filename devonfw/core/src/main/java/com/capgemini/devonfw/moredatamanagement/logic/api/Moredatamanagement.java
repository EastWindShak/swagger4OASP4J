package com.capgemini.devonfw.moredatamanagement.logic.api;
...
public interface Moredatamanagement {
   ...
   *
   * @param id The id 'id' of the MoreData.
   ...
   *
   * @param criteria the {@link MoreDataSearchCriteriaTo}.
   ...
   *
   * @param moreDataId Id of the moreData to delete
   * @return boolean <code>true</code> if the moreData can be deleted, <code>false</code> otherwise
   */
   ...
   *
   * @param moreData the {@link MoreDataEto} to create.
   * @return the new {@link MoreDataEto} that has been saved with ID and version.
   */
