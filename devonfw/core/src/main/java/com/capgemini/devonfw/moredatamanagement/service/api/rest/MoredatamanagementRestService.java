package com.capgemini.devonfw.moredatamanagement.service.api.rest;
...
/**
 * The service interface for REST calls in order to execute the logic of component {@link Moredatamanagement}.
 */
...
public interface MoredatamanagementRestService {
   ...
   *
   * @param id the ID of the {@link MoreDataEto}
   ...
   *
   * @param moredata the {@link MoreDataEto} to be saved
   ...
   *
   * @param id ID of the {@link MoreDataEto} to be deleted
   */
  @DELETE
  @Path("/moredata/{id}/")
   ...
   *
   * @param searchCriteriaTo the pagination and search criteria to be used for finding moredatas.
   * @return the {@link PaginatedListTo list} of matching {@link MoreDataEto}s.
   */
